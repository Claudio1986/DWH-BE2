...
EXEC msdb.dbo.sp_delete_job @job_name =N'BancaEmpresas_CargaIniciales', @delete_unused_schedule=1
GO
declare 
...
set 	@commando			=	N'/ISSERVER "\"\SSISDB\BE\BE\CargaInicial.dtsx\"" /SERVER '+@@servername+' /X86 /Par "\"$ServerOption::LOGGING_LEVEL(Int16)\"";1 /Par "\"$ServerOption::SYNCHRONIZED(Boolean)\"";True /CALLERINFO SQLAGENT /REPORTING E'
